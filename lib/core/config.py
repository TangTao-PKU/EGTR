...
Graphformer_DB_DIR = 'data/preprocessed_data'
...
cfg.TRAIN.DATASETS_3D = ['ThreeDPW','Human36M']
...
def parse_args():
    ...
    # parser.add_argument('--dataset', type=str, default='mpii3d', help='pick from 3dpw, mpii3d, h36m')
    # parser.add_argument('--dataset', type=str, default='h36m', help='pick from 3dpw, mpii3d, h36m')
    ...
    cfg_file = args.cfg                 # repr_table4_3dpw_model.yaml
