...
class TemporalEncoder(nn.Module):
    def __init__(
        ...
        self.pe8 = PositionalEncoding(d_model=2048,max_len=8)
        self.pe7 = PositionalEncoding(d_model=2048,max_len=7)
    ...
    def forward(self, x, is_train=False):
        ...
        x_cur = self.pe(x.permute(1,0,2)).permute(1,0,2)
        x_bef = self.pe8(x_bef.permute(1,0,2)).permute(1,0,2)
        x_aft = self.pe7(x_aft.permute(1,0,2)).permute(1,0,2)


        #self.attention
        y_cur = self.gcn16(x_cur) + x_cur
