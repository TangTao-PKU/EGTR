...
class TemporalEncoder(nn.Module):
    def __init__(
        ...
        self.layer_norm16 = nn.LayerNorm(16)
        self.layer_norm8 = nn.LayerNorm(8)
        self.layer_norm7 = nn.LayerNorm(7)
...
def test_net():
    batch_size = 1
    model = Graphformer(seqlen=16, batch_size=batch_size, n_layers=1, hidden_size=1024) # 模型初始化
    model = model.cuda()
...
# python ./lib/models/Graphformer.py
